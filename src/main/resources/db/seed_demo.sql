...
--   referee1..5@horserace.local      (RACE_REFEREE)
...
-- ADMIN
('11111111-0000-4000-8000-000000000001', (SELECT role_id FROM role WHERE role_code='ADMIN'), 'USR0002', 'Nguyễn Quản Trị',   'admin1@horserace.local',      '0900000002', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-01.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '2 hours'),
('11111111-0000-4000-8000-000000000002', (SELECT role_id FROM role WHERE role_code='ADMIN'), 'USR0003', 'Trần Điều Hành',    'admin2@horserace.local',      '0900000003', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-02.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '1 day'),
('11111111-0000-4000-8000-000000000003', (SELECT role_id FROM role WHERE role_code='ADMIN'), 'USR0004', 'Lê Giám Sát',       'admin3@horserace.local',      '0900000004', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-03.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '3 days'),
('11111111-0000-4000-8000-000000000004', (SELECT role_id FROM role WHERE role_code='ADMIN'), 'USR0005', 'Phạm Vận Hành',     'admin4@horserace.local',      '0900000005', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-04.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '5 days'),
('11111111-0000-4000-8000-000000000005', (SELECT role_id FROM role WHERE role_code='ADMIN'), 'USR0006', 'Hoàng Kỹ Thuật',    'admin5@horserace.local',      '0900000006', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-05.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '8 days'),
-- HORSE_OWNER
('11111111-0000-4000-8000-000000000011', (SELECT role_id FROM role WHERE role_code='HORSE_OWNER'), 'USR0007', 'Đặng Minh Chủ',   'horseowner1@horserace.local', '0900000007', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-06.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '4 hours'),
('11111111-0000-4000-8000-000000000012', (SELECT role_id FROM role WHERE role_code='HORSE_OWNER'), 'USR0008', 'Vũ Thanh Trại',   'horseowner2@horserace.local', '0900000008', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-07.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '2 days'),
('11111111-0000-4000-8000-000000000013', (SELECT role_id FROM role WHERE role_code='HORSE_OWNER'), 'USR0009', 'Bùi Đại Phát',    'horseowner3@horserace.local', '0900000009', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-08.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '6 days'),
('11111111-0000-4000-8000-000000000014', (SELECT role_id FROM role WHERE role_code='HORSE_OWNER'), 'USR0010', 'Ngô Kim Long',    'horseowner4@horserace.local', '0900000010', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-09.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '9 days'),
('11111111-0000-4000-8000-000000000015', (SELECT role_id FROM role WHERE role_code='HORSE_OWNER'), 'USR0011', 'Dương Bảo Ngọc',  'horseowner5@horserace.local', '0900000011', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-10.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '12 days'),
-- JOCKEY
('11111111-0000-4000-8000-000000000021', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0012', 'Lý Tuấn Kiệt',   'jockey1@horserace.local', '0900000012', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-01.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '1 hour'),
('11111111-0000-4000-8000-000000000022', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0013', 'Trịnh Gia Huy',  'jockey2@horserace.local', '0900000013', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-02.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '1 day'),
('11111111-0000-4000-8000-000000000023', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0014', 'Cao Minh Nhật',  'jockey3@horserace.local', '0900000014', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-03.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '4 days'),
('11111111-0000-4000-8000-000000000024', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0015', 'Đỗ Thành Đạt',   'jockey4@horserace.local', '0900000015', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-04.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '7 days'),
('11111111-0000-4000-8000-000000000025', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0016', 'Hồ Anh Khoa',    'jockey5@horserace.local', '0900000016', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-05.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '10 days'),
...
('11111111-0000-4000-8000-000000000026', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0027', 'Đinh Bá Lộc',    'jockey6@horserace.local', '0900000027', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-06.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '5 hours'),
('11111111-0000-4000-8000-000000000027', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0028', 'Lâm Chí Dũng',   'jockey7@horserace.local', '0900000028', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-07.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '3 days'),
('11111111-0000-4000-8000-000000000028', (SELECT role_id FROM role WHERE role_code='JOCKEY'), 'USR0029', 'Tô Hoàng Sơn',   'jockey8@horserace.local', '0900000029', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-08.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '6 days'),
...
('11111111-0000-4000-8000-000000000031', (SELECT role_id FROM role WHERE role_code='RACE_REFEREE'), 'USR0017', 'Phan Công Lý',   'referee1@horserace.local', '0900000017', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-06.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '3 hours'),
('11111111-0000-4000-8000-000000000032', (SELECT role_id FROM role WHERE role_code='RACE_REFEREE'), 'USR0018', 'Tạ Nghiêm Minh', 'referee2@horserace.local', '0900000018', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-07.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '2 days'),
('11111111-0000-4000-8000-000000000033', (SELECT role_id FROM role WHERE role_code='RACE_REFEREE'), 'USR0019', 'Chu Bình An',    'referee3@horserace.local', '0900000019', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-08.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '5 days'),
('11111111-0000-4000-8000-000000000034', (SELECT role_id FROM role WHERE role_code='RACE_REFEREE'), 'USR0020', 'Mai Chính Trực', 'referee4@horserace.local', '0900000020', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-09.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '11 days'),
('11111111-0000-4000-8000-000000000035', (SELECT role_id FROM role WHERE role_code='RACE_REFEREE'), 'USR0021', 'Đinh Trọng Tín', 'referee5@horserace.local', '0900000021', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-10.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '15 days'),
-- SPECTATOR
('11111111-0000-4000-8000-000000000041', (SELECT role_id FROM role WHERE role_code='SPECTATOR'), 'USR0022', 'Nguyễn Khán Giả', 'spectator1@horserace.local', '0900000022', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-01.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '30 minutes'),
('11111111-0000-4000-8000-000000000042', (SELECT role_id FROM role WHERE role_code='SPECTATOR'), 'USR0023', 'Trần Cổ Vũ',      'spectator2@horserace.local', '0900000023', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-02.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '6 hours'),
('11111111-0000-4000-8000-000000000043', (SELECT role_id FROM role WHERE role_code='SPECTATOR'), 'USR0024', 'Lê Hâm Mộ',       'spectator3@horserace.local', '0900000024', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-03.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '2 days'),
('11111111-0000-4000-8000-000000000044', (SELECT role_id FROM role WHERE role_code='SPECTATOR'), 'USR0025', 'Phạm Đam Mê',     'spectator4@horserace.local', '0900000025', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-04.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '4 days'),
('11111111-0000-4000-8000-000000000045', (SELECT role_id FROM role WHERE role_code='SPECTATOR'), 'USR0026', 'Võ Nhiệt Huyết',  'spectator5@horserace.local', '0900000026', '{noop}Test@1234', 'https://res.cloudinary.com/qtpgbwsh/image/upload/avatars/seed-avatar-05.jpg', 'ACTIVE', 'VERIFIED', TRUE, NOW() - INTERVAL '20 days');
...
('11111111-0000-4000-8000-000000000021', 'JK-2021-0001', 52.5, 163.0, 8, 46, 'Nài kỳ cựu, mạnh ở đoạn nước rút cuối.', 4.6, 'FRONT_RUNNER', 32.40, 'W-2-1-W-3',  5000000, 10.00, 'Cúp Mùa Xuân 2025', 29, 'Việt Nam', 'FRONT_RUNNER', 'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-1.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-1.jpg'),
('11111111-0000-4000-8000-000000000022', 'JK-2022-0007', 50.0, 160.5, 5, 23, 'Chuyên bám nhóm rồi bứt tốc ở khúc cua cuối.', 4.1, 'STALKER',      24.70, '3-W-4-2-W',  3800000,  8.50, 'Giải Cúp Sông Hồng 2024', 26, 'Việt Nam', 'STALKER',      'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-2.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-2.jpg'),
('11111111-0000-4000-8000-000000000023', 'JK-2023-0015', 54.0, 166.0, 3, 9,  'Nài trẻ, thể lực tốt, đang lên phong độ.',   3.6, 'CLOSER',       15.20, '5-3-W-6-4',  2500000,  7.00, NULL, 23, 'Việt Nam', 'CLOSER',       'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-3.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-3.jpg'),
('11111111-0000-4000-8000-000000000024', 'JK-2020-0033', 51.5, 162.0, 10, 61, 'Nhiều kinh nghiệm giải lớn, ổn định.',       4.8, 'PACE_SETTER',  38.90, 'W-W-2-W-1',  6500000, 12.00, 'Đại hội Đua ngựa QG 2025', 32, 'Việt Nam', 'PACE_SETTER', 'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-4.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-4.jpg'),
('11111111-0000-4000-8000-000000000025', 'JK-2024-0002', 49.5, 158.0, 2, 4,  'Tân binh, vừa hoàn tất khoá đào tạo nài.',   3.1, 'STALKER',       9.80, '7-5-4-6-3',  1800000,  6.00, NULL, 21, 'Việt Nam', 'STALKER',      'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-5.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-5.jpg'),
('11111111-0000-4000-8000-000000000026', 'JK-2022-0019', 53.0, 164.5, 6, 31, 'Đọc thế trận tốt, mạnh ở cự ly 1600m.',      4.3, 'STALKER',      27.10, 'W-3-2-W-4',  4200000,  9.00, 'Cúp Duyên Hải 2025', 27, 'Việt Nam', 'STALKER',     'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-1.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-1.jpg'),
('11111111-0000-4000-8000-000000000027', 'JK-2023-0028', 51.0, 161.0, 4, 17, 'Xuất phát nhanh, giữ nhịp ổn định.',         3.9, 'FRONT_RUNNER', 21.60, '2-W-5-3-W',  3300000,  8.00, NULL, 25, 'Việt Nam', 'FRONT_RUNNER', 'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-2.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-2.jpg'),
('11111111-0000-4000-8000-000000000028', 'JK-2021-0044', 52.0, 163.5, 7, 38, 'Bền bỉ, chuyên cự ly dài trên 2000m.',       4.4, 'CLOSER',       29.80, 'W-W-3-2-W',  4800000,  9.50, 'Giải Cao Nguyên 2025', 30, 'Việt Nam', 'CLOSER',    'https://res.cloudinary.com/qtpgbwsh/image/upload/licenses/seed-license-3.jpg', 'https://res.cloudinary.com/qtpgbwsh/image/upload/certificates/seed-certificate-3.jpg');
...
('12222222-0000-4000-8000-000000000001','22222222-0000-4000-8000-000000000001','VACCINATION','Tiêm phòng cúm ngựa mũi 2','Vaccine EI, không phản ứng phụ.', '2026-05-02','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-01.jpg','vaccine-hrs0001.jpg'),
('12222222-0000-4000-8000-000000000002','22222222-0000-4000-8000-000000000001','CERTIFICATE','Giấy chứng nhận sức khoẻ 2026','Đủ điều kiện thi đấu đến hết 2026.','2026-05-02','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-02.jpg','health-cert-hrs0001.jpg'),
('12222222-0000-4000-8000-000000000003','22222222-0000-4000-8000-000000000002','VACCINATION','Tiêm phòng uốn ván','Định kỳ hằng năm.','2026-04-18','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-03.jpg','vaccine-hrs0002.jpg'),
('12222222-0000-4000-8000-000000000004','22222222-0000-4000-8000-000000000003','CERTIFICATE','Chứng nhận nhập khẩu & kiểm dịch','Nhập từ UAE, đã qua kiểm dịch 21 ngày.','2026-06-01','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-04.jpg','import-cert-hrs0003.jpg'),
('12222222-0000-4000-8000-000000000005','22222222-0000-4000-8000-000000000004','INJURY','Căng cơ chân sau trái','Nghỉ thi đấu 3 tuần, vật lý trị liệu 2 lần/tuần.','2026-07-16','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-05.jpg','injury-hrs0004.jpg'),
...
('12222222-0000-4000-8000-000000000007','22222222-0000-4000-8000-000000000006','VACCINATION','Tiêm phòng cúm ngựa mũi 1','Mũi 2 dự kiến sau 4 tuần.','2026-04-30','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-06.jpg','vaccine-hrs0006.jpg'),
('12222222-0000-4000-8000-000000000008','22222222-0000-4000-8000-000000000007','NOTE','Cách ly sau vận chuyển','Theo dõi thân nhiệt 2 lần/ngày trong 14 ngày.','2026-07-18','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-07.jpg','quarantine-hrs0007.jpg'),
('12222222-0000-4000-8000-000000000009','22222222-0000-4000-8000-000000000008','CERTIFICATE','Chứng nhận Coggins âm tính','Xét nghiệm EIA âm tính.','2026-06-10','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-08.jpg','coggins-hrs0008.jpg'),
('12222222-0000-4000-8000-000000000010','22222222-0000-4000-8000-000000000009','INJURY','Thoái hoá khớp gối','Không đủ điều kiện thi đấu, đề xuất giải nghệ.','2026-05-20','https://res.cloudinary.com/qtpgbwsh/image/upload/medical/seed-medical-09.jpg','retire-hrs0009.jpg');
...
('44444444-0000-4000-8000-000000000001','TRN00002','Cúp Mùa Xuân 2026','Giải mở màn mùa giải 2026, cự ly trung bình.',            NOW() - INTERVAL '90 days', NOW() - INTERVAL '85 days', NOW() - INTERVAL '120 days', NOW() - INTERVAL '95 days','TP. Hồ Chí Minh','GROUP_2', 800000000, 24, TRUE,  3, FALSE,'COMPLETED',        'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-01.jpg','11111111-0000-4000-8000-000000000001'),
('44444444-0000-4000-8000-000000000002','TRN00003','Giải Vô Địch Quốc Gia 2026','Giải đấu lớn nhất năm, quy tụ ngựa hàng đầu.',   NOW() - INTERVAL '3 days',  NOW() + INTERVAL '4 days',  NOW() - INTERVAL '40 days',  NOW() - INTERVAL '10 days','Hà Nội','GROUP_1',        2500000000, 32, TRUE,  4, TRUE, 'ONGOING',          'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-02.jpg','11111111-0000-4000-8000-000000000001'),
('44444444-0000-4000-8000-000000000003','TRN00004','Cúp Duyên Hải 2026','Giải ven biển, mặt sân tổng hợp.',                        NOW() + INTERVAL '25 days', NOW() + INTERVAL '28 days', NOW() - INTERVAL '5 days',   NOW() + INTERVAL '15 days','Quảng Ninh','GROUP_3',    450000000, 18, FALSE, 3, FALSE,'REGISTRATION_OPEN','https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-03.jpg','11111111-0000-4000-8000-000000000002'),
('44444444-0000-4000-8000-000000000004','TRN00005','Giải Cao Nguyên 2026','Thi đấu ở độ cao 1500m, thử thách sức bền.',            NOW() + INTERVAL '10 days', NOW() + INTERVAL '12 days', NOW() - INTERVAL '30 days',  NOW() - INTERVAL '2 days','Lâm Đồng','LISTED',         280000000, 16, FALSE, 3, FALSE,'REGISTRATION_CLOSED','https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-04.jpg','11111111-0000-4000-8000-000000000002'),
('44444444-0000-4000-8000-000000000005','TRN00006','Cúp Sông Hồng 2026','Giải truyền thống miền Bắc.',                             NOW() + INTERVAL '55 days', NOW() + INTERVAL '58 days', NOW() + INTERVAL '20 days',  NOW() + INTERVAL '45 days','Hà Nội','GROUP_2',        620000000, 20, TRUE,  3, FALSE,'PUBLISHED',        'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-05.jpg','11111111-0000-4000-8000-000000000003'),
('44444444-0000-4000-8000-000000000006','TRN00007','Giải Giao Hữu Mở Rộng','Bản nháp, chưa công bố.',                               NOW() + INTERVAL '80 days', NOW() + INTERVAL '82 days', NOW() + INTERVAL '50 days',  NOW() + INTERVAL '75 days','Bình Dương','LISTED',     120000000, 12, FALSE, 2, FALSE,'DRAFT',            'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-06.jpg','11111111-0000-4000-8000-000000000003'),
('44444444-0000-4000-8000-000000000007','TRN00008','Cúp Tam Đảo 2026','Huỷ do điều kiện thời tiết cực đoan kéo dài.',               NOW() + INTERVAL '18 days', NOW() + INTERVAL '20 days', NOW() - INTERVAL '25 days',  NOW() + INTERVAL '5 days','Vĩnh Phúc','GROUP_3',      200000000, 14, FALSE, 3, FALSE,'CANCELLED',        'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-07.jpg','11111111-0000-4000-8000-000000000004'),
('44444444-0000-4000-8000-000000000008','TRN00001','Giải Tổng Kết 2025','Giải khép lại mùa 2025.',                                  NOW() - INTERVAL '200 days',NOW() - INTERVAL '196 days',NOW() - INTERVAL '240 days', NOW() - INTERVAL '210 days','Đà Nẵng','GROUP_2',      700000000, 22, TRUE,  3, FALSE,'COMPLETED',        'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-08.jpg','11111111-0000-4000-8000-000000000004'),
('44444444-0000-4000-8000-000000000009','TRN00009','Cúp Đảo Ngọc 2026','Giải trên đảo, quy mô nhỏ.',                                NOW() + INTERVAL '35 days', NOW() + INTERVAL '36 days', NOW() - INTERVAL '2 days',   NOW() + INTERVAL '25 days','Hải Phòng','LISTED',      150000000, 10, FALSE, 3, FALSE,'REGISTRATION_OPEN','https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-09.jpg','11111111-0000-4000-8000-000000000005'),
('44444444-0000-4000-8000-000000000010','TRN00010','Siêu Cúp Quốc Tế 2026','Mời đội quốc tế, cự ly dài.',                            NOW() + INTERVAL '120 days',NOW() + INTERVAL '125 days',NOW() + INTERVAL '60 days',  NOW() + INTERVAL '110 days','Hà Nội','GROUP_1',      3000000000, 30, TRUE,  4, TRUE, 'PUBLISHED',        'https://res.cloudinary.com/qtpgbwsh/image/upload/tournaments/seed-tournament-10.jpg','11111111-0000-4000-8000-000000000005');
...
('55555555-0000-4000-8000-000000000015','44444444-0000-4000-8000-000000000002','RACE00015','Vòng loại B - Vô Địch QG','FLAT',1400,'GOOD','SUNNY', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days' + INTERVAL '95 seconds', NOW() - INTERVAL '2 days' - INTERVAL '15 minutes', 12, 5,'Trường đua Sóc Sơn','33333333-0000-4000-8000-000000000003', 27, 300000000, 2500000,  9.5,'NE','NEUTRAL','https://res.cloudinary.com/qtpgbwsh/image/upload/photofinish/seed-photofinish-05.jpg', NULL, NULL, NULL,'Đang chờ trọng tài chính xác nhận.','FINISHED');
...
-- =========================================================
-- RACE_PRIZE_DISTRIBUTION — chỉ cho race đã có kết quả
-- =========================================================
...
('a4444444-0000-4000-8000-000000000001','APP-7B2E44D1','JOCKEY','APPROVED',      'NORMAL','Lý Tuấn Kiệt',   '1997-03-12', NULL,'jockey1@horserace.local','0900000012','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-01.jpg','Hà Nội',        NULL,        'VALID',  '0010****4521','A','ACTIVE','2027-06-30','PASSED',  NOW() - INTERVAL '400 days', NOW() - INTERVAL '395 days','11111111-0000-4000-8000-000000000031', NULL, NULL,'11111111-0000-4000-8000-000000000021'),
('a4444444-0000-4000-8000-000000000002','APP-3F91C2A5','OWNER', 'APPROVED',      'NORMAL','Đặng Minh Chủ',  '1985-08-25','0312****89','horseowner1@horserace.local','0900000007','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-02.jpg','Hà Nội','Trại ngựa Minh Long','VALID','0010****7788', NULL, NULL, NULL,'PASSED', NOW() - INTERVAL '500 days', NOW() - INTERVAL '494 days','11111111-0000-4000-8000-000000000031', NULL, NULL,'11111111-0000-4000-8000-000000000011'),
('a4444444-0000-4000-8000-000000000003','APP-C8D0B6E4','JOCKEY','PENDING',       'URGENT','Nguyễn Văn Hùng','2001-11-02', NULL,'hung.nguyen.applicant@example.com','0911000001','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-03.jpg','TP. Hồ Chí Minh',NULL,      'PENDING','0079****1122','B','NONE',   NULL,       'PENDING', NOW() - INTERVAL '2 days', NULL, NULL, NULL, NULL, NULL),
('a4444444-0000-4000-8000-000000000004','APP-A1F73B92','OWNER', 'UNDER_REVIEW',  'NORMAL','Trần Thị Mai',   '1990-05-19','0313****45','mai.tran.applicant@example.com','0911000002','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-04.jpg','Bình Dương','Mai Stable','VALID','0079****3344', NULL, NULL, NULL,'PENDING', NOW() - INTERVAL '5 days', NULL, NULL, NULL, NULL, NULL),
('a4444444-0000-4000-8000-000000000005','APP-6E24D5C8','JOCKEY','INFO_REQUESTED','NORMAL','Phạm Quốc Bảo',  '2003-01-30', NULL,'bao.pham.applicant@example.com','0911000003','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-05.jpg','Đà Nẵng',      NULL,        'PENDING','0048****5566','C','NONE',   NULL,       'PENDING', NOW() - INTERVAL '8 days', NOW() - INTERVAL '6 days','11111111-0000-4000-8000-000000000032', NULL,'Vui lòng bổ sung giấy chứng nhận sức khoẻ còn hiệu lực trong 30 ngày.', NULL),
('a4444444-0000-4000-8000-000000000006','APP-B9C15A37','JOCKEY','REJECTED',      'NORMAL','Võ Thành Nam',   '2008-07-14', NULL,'nam.vo.applicant@example.com','0911000004','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-06.jpg','Cần Thơ',      NULL,        'FAILED', '0092****7788', NULL,'NONE',   NULL,       'FAILED',  NOW() - INTERVAL '15 days', NOW() - INTERVAL '12 days','11111111-0000-4000-8000-000000000032','Chưa đủ 16 tuổi theo quy định tối thiểu cho nài ngựa.', NULL, NULL),
('a4444444-0000-4000-8000-000000000007','APP-D4E86F21','OWNER', 'REJECTED',      'NORMAL','Hoàng Gia Bảo',  '1979-09-08','0314****11','baohoang.applicant@example.com','0911000005','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-07.jpg','Hải Dương','Gia Bảo Farm','FAILED','0030****9900', NULL, NULL, NULL,'FAILED', NOW() - INTERVAL '25 days', NOW() - INTERVAL '20 days','11111111-0000-4000-8000-000000000033','Giấy tờ pháp nhân không khớp với mã số thuế cung cấp.', NULL, NULL),
('a4444444-0000-4000-8000-000000000008','APP-2A7B93C6','OWNER', 'APPROVED',      'NORMAL','Vũ Thanh Trại',  '1988-12-01','0315****22','horseowner2@horserace.local','0900000008','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-08.jpg','TP. Hồ Chí Minh','Thanh Trại Stable','VALID','0079****2233', NULL, NULL, NULL,'PASSED', NOW() - INTERVAL '450 days', NOW() - INTERVAL '445 days','11111111-0000-4000-8000-000000000031', NULL, NULL,'11111111-0000-4000-8000-000000000012'),
('a4444444-0000-4000-8000-000000000009','APP-F05D1E48','JOCKEY','PENDING',       'URGENT','Bùi Khánh Linh', '2002-04-22', NULL,'linh.bui.applicant@example.com','0911000006','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-09.jpg','Hà Nội',       NULL,        'VALID',  '0010****4455','B','ACTIVE','2028-01-15','PASSED', NOW() - INTERVAL '1 day', NULL, NULL, NULL, NULL, NULL),
('a4444444-0000-4000-8000-000000000010','APP-8C36A2B7','OWNER', 'UNDER_REVIEW',  'NORMAL','Ngô Kim Long',   '1982-02-11','0316****33','horseowner4@horserace.local','0900000010','https://res.cloudinary.com/qtpgbwsh/image/upload/applications/seed-applicant-10.jpg','Lâm Đồng','Kim Long Equestrian','VALID','0068****6677', NULL, NULL, NULL,'PENDING', NOW() - INTERVAL '3 days', NULL, NULL, NULL, NULL,'11111111-0000-4000-8000-000000000014');
