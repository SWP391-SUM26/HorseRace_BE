...
public enum ErrorCode {
    ...
    EMAIL_VERIFICATION_FAILED(1013, "Email verification failed or token expired", HttpStatus.BAD_REQUEST),
    ACCOUNT_ALREADY_ACTIVE(1014, "Account is already active", HttpStatus.BAD_REQUEST);
