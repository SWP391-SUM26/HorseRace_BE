...
/**
 * Body for GET /api/v1/races/{raceId}/live — poll snapshot of a running race
 * (FE-v2 mục 4).
 *
 * <p>
 * Polling fallback. There is no live telemetry source yet, so
 * {@code currentSpeedKph} is always
 * null; {@code raceClockMs} is derived from {@code actual_start_at}. See the
 * service for the
 * WebSocket TODO.
 */
@Data
